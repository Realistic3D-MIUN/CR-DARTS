...
parser.add_argument('--init_channels', type=int, default=36, help='num of init channels') # P-DARTS: 16, Proposed: 36, DARTS: 16, PC-DARTS: 16
parser.add_argument('--layers', type=int, default=20, help='total number of layers') # P-DARTS: 5, Proposed: 20, DARTS: 8, PC-DARTS: 8
