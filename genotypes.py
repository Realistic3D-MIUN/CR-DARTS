...
PARAMETERIZED_PRIMITIVES = [
    'sep_conv_3x3',
    'sep_conv_5x5',
    'dil_conv_3x3',
    'dil_conv_5x5',
    #'conv_7x1_1x7',  # if you want to include this as well
]

# Optional: full list for backward compatibility
ALL_PRIMITIVES = PARAMETER_FREE_PRIMITIVES + PARAMETERIZED_PRIMITIVES
...
PD_DARTS = Genotype(
    ...
    normal_concat=list(range(2, 6)),  # FIXED
    ...
    reduce_concat=list(range(2, 6))  # FIXED
)

# Proposed CR-DARTS
CR_DARTS_CIFAR = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_5x5', 2), ('sep_conv_3x3', 0), ('sep_conv_3x3', 2)], normal_concat=range(2, 6), reduce=[('avg_pool_3x3', 0), ('avg_pool_3x3', 1), ('avg_pool_3x3', 0), ('avg_pool_3x3', 1), ('avg_pool_3x3', 0), ('avg_pool_3x3', 2), ('avg_pool_3x3', 0), ('avg_pool_3x3', 1)], reduce_concat=range(2, 6))

CR_DARTS_IMAGENET = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('dil_conv_3x3', 2), ('sep_conv_3x3', 0), ('sep_conv_5x5', 3), ('avg_pool_3x3', 0), ('dil_conv_3x3', 2)], normal_concat=range(2, 6), reduce=[('avg_pool_3x3', 0), ('sep_conv_5x5', 1), ('max_pool_3x3', 0), ('dil_conv_5x5', 2), ('dil_conv_5x5', 0), ('dil_conv_3x3', 3), ('dil_conv_3x3', 1), ('sep_conv_3x3', 3)], reduce_concat=range(2, 6))
