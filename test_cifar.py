...
parser.add_argument('--model_path', type=str, default='./outputs/crdarts_cifar', help='path of pretrained model')
...
def main():
  ...
  model = model.cuda()
  utils.load(model, args.model_path + str(CIFAR_CLASSES) + '_weights.pt')
